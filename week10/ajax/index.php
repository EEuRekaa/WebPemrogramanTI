...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384 fnmDCqb1lwilj8ly1jo/moustjsKC4popQbqyi/RrhNudi9RwhKkMlpvbliG95r" crossorigin="anonymous">
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() { //Mengirimkan Token Keamanan
            $.ajaxSetup({
                headers: {
